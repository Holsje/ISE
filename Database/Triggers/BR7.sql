ALTER TRIGGER trEventInMultipleTracksOverlap_BR7
ON dbo.EventInTrack
AFTER INSERT
AS 
BEGIN
	...
	BEGIN TRY
		...
		IF EXISTS(SELECT 1
					...
					WHERE ((I.Start BETWEEN EIT.Start AND EIT.[End]) OR (I.[End] BETWEEN EIT.Start AND EIT.[End]) OR (I.Start <= EIT.Start AND I.[End] >= EIT.[End]))
					)
		BEGIN
...
BEGIN TRAN
	...
	INSERT INTO EventInTrack (TRA_CongressNo, TrackNo, CongressNo, EventNo, Start, [End]) VALUES (1, 2, 1, 1, '2016-10-10 14:00:00', '2016-10-10 14:05:00'),
