...
INSERT INTO EVENTINTRACK VALUES(1, 1, 1, 100, '2016-10-10 09:00:00', '2016-10-10 14:00:00') 
ROLLBACK TRANSACTION 

-- goed, Starttijd voor en eindtijd voor
BEGIN TRANSACTION
INSERT INTO EVENT VALUES(1, 100, 'Een overlappend event', 'lezing', 50, NULL, 'img/', 'test')
INSERT INTO EVENTINTRACK VALUES(1, 1, 1, 100, '2016-10-10 09:05:00', '2016-10-10 11:50:00') 
ROLLBACK TRANSACTION

-- fout, Starttijd na en eindtijd na
BEGIN TRANSACTION
INSERT INTO EVENT VALUES(1, 100, 'Een overlappend event', 'lezing', 50, NULL, 'img/', 'test')
INSERT INTO EVENT VALUES(1, 101, 'Nog een event', 'lezing', 50, NULL, 'img/', 'test')
INSERT INTO EVENTINTRACK VALUES(1, 1, 1, 101, '2016-10-10 13:10:00', '2016-10-10 13:50:00'),
							   (1, 1, 1, 100, '2016-10-10 12:05:00', '2016-10-10 13:05:00') 
ROLLBACK TRANSACTION
...
INSERT INTO EVENT VALUES(1, 101, 'Nog een event', 'lezing', 50, NULL, 'img/', 'test')
INSERT INTO EVENTINTRACK VALUES(1, 1, 1, 101, '2016-10-10 13:10:00', '2016-10-10 13:50:00'), 
							   (1, 1, 1, 100, '2016-10-10 12:10:00', '2016-10-10 12:50:00') 
ROLLBACK TRANSACTION