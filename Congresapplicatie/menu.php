<nav role="navigation" class="navbar navbar-default largeMenu col-xs-12 col-sm-12 col-md-12">
    <div class="navbar-header col-xs-12 col-sm-12 col-md-12">
        <div class="input-group col-xs-12 col-sm-12 col-md-12">
            <?php
                echo'<button type="button" name="planCongress" class="col-md-1 btn btn-default plan" onClick="location.href=&quot;inschrijven.php&quot;">'.$_SESSION['translations']['planCongress'].'</button>';
