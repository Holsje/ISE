...
require_once('Date.php');
    ...
    class CreateScreen{
        ...
        public function createForm($screenObjects,$formName, $extraCssClasses){
            echo '<form name="'. $formName . '" class="form-horizontal col-md-offset-1 col-sm-offset-1 col-xs-offset-1 col-xs-8 col-sm-10 col-md-10 ' . $extraCssClasses . '" method="POST" action="'.$_SERVER['PHP_SELF']. '">';
        ...
        public function createPopup($screenObjects,$title,$popupId,$extraCssClasses){
            echo '<div id="' . $popupId . '"  class="popup col-sm-12 col-md-12 col-xs-12 ' . $extraCssClasses . '">';
				echo '<div class="popupWindow col-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6 col-xs-offset-3 col-xs-6">';
					...
					echo '</div>';
			$this->createForm($screenObjects, $popupId . "form" ,"formPopup");
				echo '</div>';
            echo '</div>';
        }
    }
