		...
		public function createDataSwapList($tableLeft,$tableRight,$keepRight) {
			if($keepRight == true) {
				...
				echo '<div class="col-sm-2 col-xs-2 col-md-2 dataSwapListMiddle"> ';
					$buttonLeft = new Button("<","<","<",'form-control btn btn-default goToLeftButton dataSwapButton',true,true,'listBoxLeftSpeaker');
					$buttonRight = new Button(">",">",">",'form-control btn btn-default goToRightButton dataSwapButton',true,true,'listBoxRightSpeaker');
